...
export function PermisosTurno() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end justify-center bg-black/50 p-4 backdrop-blur-sm sm:items-center sm:p-0">
      <div className="max-h-[92vh] w-full max-w-md overflow-y-auto rounded-[32px] bg-[#FFFFFF] shadow-2xl duration-300 animate-in slide-in-from-bottom-8 sm:zoom-in-95 dark:bg-[#2C2C2E]">
